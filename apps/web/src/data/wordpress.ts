...
export const fetchArticle = async (wpSearchOptions: WPSearchOptions, fields: ArticleQueryField[] = ["title", "author", "date", "categories", "image", "content"]): Promise<ArticleRaw | ArticleRaw[]> => {
